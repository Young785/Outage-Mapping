...
export const PAGE_HELP: Record<PageHelpId, PageHelpContent> = {
  ...
  admin: {
    ...
    steps: [
      ...
      { title: "Test rerouting in simulation", detail: "Storm Simulation Mode → Generate Clustered or Honey Hole synthetic outages (this also turns Simulation ON) → open Live Map. Dots are 1–10 customers so they render on the map. Techs can Route to Next on fake data to verify phase logic." },
    ...
    inputs: [
      ...
      { name: "Generate outages button", description: "Creates synthetic Twin Cities dots, turns Simulation ON, and refreshes the map. Open Live Map to see them. Does not affect live feeds." },
